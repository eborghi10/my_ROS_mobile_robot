...
#include <my_robot_control/my_robot_hardware.h>

void controlLoop(my_robot_base::AmpruHardware &hw, controller_manager::ControllerManager &cm, std::chrono::system_clock::time_point &last_time)
{
...
int main(int argc, char** argv)
{
    ...
    my_robot_base::MyRobotHardware hw(nh, private_nh);
